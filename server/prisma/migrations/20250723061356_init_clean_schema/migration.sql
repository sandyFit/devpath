...
CREATE TABLE "project_statistics" (
    ...
    "average_complexity_score" DOUBLE PRECISION,
    "average_security_score" DOUBLE PRECISION,
    ...
    CONSTRAINT "project_statistics_pkey" PRIMARY KEY ("stats_id")
);
...
-- AddForeignKey
ALTER TABLE "project_statistics" ADD CONSTRAINT "project_statistics_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("project_id") ON DELETE RESTRICT ON UPDATE CASCADE;
